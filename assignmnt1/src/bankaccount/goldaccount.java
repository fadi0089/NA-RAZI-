...
public class goldaccount implements banktransaction{
	...
	{   int choice;
	 ...
	 goldaccount(createaccount create)
	{
		decision();
	}
	public void deposit()
	{
		...
		totlblnc=newblnc;
		System.out.println("Your new balance after deposit is:$"+newblnc);
		decision();
	}
	long getbalance()
	{
